...
// Support DirectX API - define via build settings instead!
//#ifdef _WIN32
//#define ILUT_USE_DIRECTX
//#endif
...
/* png support (PNG is a smart, loselss and even open format. libpng powered.) */
#undef IL_NO_PNG
...
/* tiff support (TIFF is a lossless format supporting greater color depths.
   libtiff powered) */
// define it via project settings when desired
//#define HAVE_LIBTIFF
...
// Define as __stdcall if you have and want to use _stdcall calling convention, or leave it undefined
#ifdef _WIN32
#define API_CALL_CONV __stdcall
#else
#define API_CALL_CONV 
#endif

// Upscaling uses a nearest filter by default. Define ADVANCED_UPSCALE_FILTERING to use other filters.
//#define ADVANCED_UPSCALE_FILTERING

// API 1 is deprecated and will be no longer delivered in builds
#undef IL_API1_SUPPORT

// Undefine these to disable HEIC/AVIF support
// define HAVE_LIBHEIF via project settings when desired to enable them
#if defined(HAVE_LIBHEIF)
#define IL_HEIC_SUPPORT
#define IL_AVIF_SUPPORT
#else
#undef IL_HEIC_SUPPORT
#undef IL_AVIF_SUPPORT
#endif
