...
ILAPI ILboolean      ILAPIENTRY iluBuildMipmaps(ILenum filter);
...
#define iluErrorString il2ErrorString
...
ILAPI ILboolean      ILAPIENTRY iluReplaceColour(ILubyte minRed, ILubyte minGreen, ILubyte minBlue,
...
ILAPI ILboolean      ILAPIENTRY iluScale(ILuint Width, ILuint Height, ILuint Depth, ILenum filter);
